#!/usr/bin/env python3
"""
Bedrock AgentCore with Strands Framework - Complete SAP Integration
This agent imports SAP functions from utils and makes them available as Strands tools.
The SAP functions connect to the real SAP OData API and return actual inventory data.
"""
...
# Import SAP API functions - MUST be available
import sys
...
try:
    ...
    print("[Agent] ✓ SAP API functions loaded successfully")
except ImportError as e:
    print(f"[Agent] ✗ CRITICAL: SAP API functions not available: {e}")
...
try:
    ...
    print(f"[Agent] Warning: Langfuse not available: {e}")
